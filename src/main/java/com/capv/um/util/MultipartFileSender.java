...
public class MultipartFileSender {
    ...
    public static MultipartFileSender fromInputStream(InputStream inputStream) {
        return new MultipartFileSender().setInputStream(inputStream);
    }

    public static MultipartFileSender fileName(String  fileName) {
        return new MultipartFileSender().setFileName(fileName);
    }

    //** internal setter **//
    private MultipartFileSender setInputStream(InputStream inputStream) {
    ...
    public void serveResource(InputStream inputStream,Long length ) throws Exception {
